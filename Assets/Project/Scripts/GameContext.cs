...
public static readonly bool IsDebugMode = true;
    ...
    public class Data : BaseData<Data>
    {
...
#endif
        private WarehouseData _activeWarehouseData;
        public WarehouseData activeWarehouseData
        {
            get
            {
        ...
        private WarehouseMetaData.LevelMetaData _activeWarehouseLevelMeta;
        public WarehouseMetaData.LevelMetaData activeWarehouseLevelMeta
        {
            get
            {
        ...
        public void SetActiveData(GameContext context, WarehouseData warehouseData, string relativePath = null)
        {
            var previousData = this._activeWarehouseData;
            WarehouseMetaData.LevelMetaData levelMetaData = null;

            if (previousData?.Identifier == warehouseData.Identifier)
            {
                var comparer = new WarehouseData.Comparer();
            ...
            {
                var metaData = context.file.Get<WarehouseMetaData>();
            ...
            if (levelMetaData == null)
            {
                levelMetaData = new WarehouseMetaData.LevelMetaData(warehouseData);
            }
        ...
        public bool MoveNext(GameContext context, CategoryType? categoryOverride = null)
        {
            ...
            // get level list
            var levels = context.file.GetDirectoryFilePaths<WarehouseData>(appendedDirectory: currentCategory.ToString(), allowCache: true);
            Array.Sort(levels);
            ...
            var levelData = context.file.LoadJson<WarehouseData>(levelPath);
    ...
    {
        public static WarehouseData BlueTest => new WarehouseData
        {
        ...
        public static WarehouseData MarkerTest => new WarehouseData
        {
